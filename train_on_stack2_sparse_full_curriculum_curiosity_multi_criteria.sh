...
GPU_EXAMPLE="For example, if you have two GPUs with device numbers 0 and 1, to use both of them, set ALL_GPUS to the string \"[0, 1]\".\nIf you have one GPU, set ALL_GPUS to the string \"[0]\".\n\n"
...
mpiexec -np 8 python -m ddpg_curiosity_mc_her.ddpg.main \
